...
function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full rounded-b-xl bg-white dark:bg-boxdark-2 ${
        isScrolling ? "shadow-[0_5px_10px_rgba(154,161,177,.1)]" : ""
      }`}
    >
      <nav
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 dark:bg-boxdark dark:text-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
